  ...
  return (
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Active Deposits */}
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-lg relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-600 text-sm">Available Deposits</p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full max-w-3xl bg-white rounded-xl p-6 border border-gray-200 shadow-lg flex flex-col gap-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-bold text-gray-900">Deposit History</h3>
          </div>
